...
if __name__ == '__main__':
    ...
    ap.add_argument("-r", "--range", required=False, help="range of lsh [format: -r arg1 arg2 ]; default: 50 to 95", metavar="", type=int, default=(50, 95), nargs=2)
